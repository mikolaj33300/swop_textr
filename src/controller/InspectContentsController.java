...
public class InspectContentsController extends UseCaseController {
    ...
    public void handle(int b) throws IOException {
        switch(b) {
            ...
            // Control + P
            case 16:
                coreControllerParent.rootLayout.getNeighborsContainedHash(DIRECTION.LEFT);
                break;
            // Control + N
            case 14:
                coreControllerParent.rootLayout.getNeighborsContainedHash(DIRECTION.RIGHT);
                break;
            // Control + R
            case 18:
                coreControllerParent.rootLayout.rotateRelationshipNeighbor(ROT_DIRECTION.COUNTERCLOCKWISE, hash);
                break;
            // Control + T
            case 20:
                coreControllerParent.rootLayout.rotateRelationshipNeighbor(ROT_DIRECTION.CLOCKWISE, hash);
                break;
            // Surrogate keys
            case 27:
                Terminal.readByte();

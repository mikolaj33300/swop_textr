...
public class LayoutNodeTest {
    ...
    void testRotateRelationshipNeighbor(){
        ...
        Layout newRotatedLayout = current_layout.rotateRelationshipNeighbor(Layout.ROT_DIRECTION.CLOCKWISE);
        VerticalLayoutNode vn3 = new VerticalLayoutNode(new ArrayList<>(Arrays.asList(l1,l2)));
        assertEquals(newRotatedLayout,vn3);
